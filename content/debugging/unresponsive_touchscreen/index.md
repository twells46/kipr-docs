...
Sometimes, if the top case is too tight, the touchscreen registers the case itself as a touch and becomes unresponse to user input.
...
If it receives too many inputs too fast, the [[BotUI]] can become overloaded and unresponsive.
...
[[BotUI]] includes a tool to reverse the screen to make it easier to use if your Wombat is mounted on your robot in certain (which?) orientations.
...
1. Type command below *exactly* as it appears.
...
In this case, please email our support team at [support@kipr.org](mailto:support@kipr.org) and our staff can create a support ticket so that you can send the broken Wombat in for repair.
